...
public class SamplesCommandTest {
	...
	public void testGetSampleClientExtension() throws Exception {
		...
		String[] args = {"samples client-extensions", "-d", root.getPath() + "/client-extensions", "liferay-sample-global-css"};
	...
	public void testGetSampleWithGradleWrapperExisting() throws Exception {
		String[] initArgs = {
			"--base", _rootDir.getPath() + "/test/workspace", "init", "-v", BladeTest.PRODUCT_VERSION_DXP_72
		};
