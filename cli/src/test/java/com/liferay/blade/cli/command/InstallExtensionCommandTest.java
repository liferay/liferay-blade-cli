...
public class InstallExtensionCommandTest {
	...
	private static final String _LINK_TO_DEPLOY_COMMAND = "https://github.com/christopherbryanboyd/liferay-blade-cli/tree/deployremote/extensions/deploy-remote-command";
