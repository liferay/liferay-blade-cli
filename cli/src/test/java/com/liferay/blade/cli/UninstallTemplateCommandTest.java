...
import com.liferay.blade.cli.command.UninstallTemplate;
 ...
 */
@PrepareForTest({UninstallTemplate.class, BladeUtil.class})
...
public class UninstallTemplateCommandTest {
	...
	public void testUninstallTemplate() throws Exception {
		...
		PowerMock.mockStaticPartialNice(BladeUtil.class, "getCustomTemplatesPath");

		IExpectationSetters<Path> templatesDirMethod = EasyMock.expect(BladeUtil.getCustomTemplatesPath());
