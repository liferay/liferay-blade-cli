 ...
 */
public class InstallTemplate extends BaseCommand<InstallTemplateArgs> {
	...
	@Override
	public Class<InstallTemplateArgs> getArgsClass() {
		return InstallTemplateArgs.class;
	}
	...
	private void _installTemplate(Path templatePath) throws IOException {
		Path templatesHome = BladeUtil.getCustomTemplatesPath();
		...
		getBladeCLI().out("The template " + newTemplatePath.getFileName() + " has been installed successfully.");
	}
