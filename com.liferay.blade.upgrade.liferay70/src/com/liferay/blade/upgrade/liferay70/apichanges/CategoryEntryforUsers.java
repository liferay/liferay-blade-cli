...
@Component(
	property = {
		"file.extensions=xml",
		"problem.title=Deprecated Category Entry for Users",
		"problem.summary=The category entry for Site Administration ¡ú Users has been deprecated in favor of Site Administration ¡ú Members.",
		"problem.tickets=LPS-63466",
		"problem.section=#deprecated-category-entry-for-users"
	},
