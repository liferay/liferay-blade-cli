...
public class BndProperties extends Properties {
	...
	public void addValue(
			final String key, final BndPropertiesValue newBdValue) {
		...
		if (bdValue != null) {
			...
			if (originalValue != null && !"".equals(originalValue)) {
				StringBuilder formatedValueBuilder =
					new StringBuilder(bdValue.getFormatedValue());
				StringBuilder originalValueBuilder =
					new StringBuilder(bdValue.getOriginalValue());
	...
	private void formatForOutput(
		String str, StringBuilder buffer, boolean key) {
